        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <Link className="nav-link active modern-link" aria-current="page" to="/Articles" style={{ fontFamily, fontSize: fontSizeLink, marginRight: '10px', color: fontColor }}>Health Articles</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link active modern-link" aria-current="page" to="/Chatbot" style={{ fontFamily, fontSize: fontSizeLink, marginRight: '10px', color: fontColor }}>AI Chatbot</Link>
              </li>
