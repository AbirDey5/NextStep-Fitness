...
// First commit to test ui branch
...
function AppContent({ isloggedin, setisloggedin, alertMessage, setAlertMessage, openSnackbar, setOpenSnackbar, username, setUsername, password, setPassword, user_id, setUser_id, admin_id, setAdmin_id, admin_password, setAdmin_password, isloggedin_admin, setisloggedin_admin, trainer_id, setTrainer_id, trainer_password, setTrainer_password, isloggedin_trainer, setisloggedin_trainer, loginType, setLoginType, globalState, setGlobalState }) {
  ...
  return (
    <>
      ...
      {/* {location.pathname !== '/' && location.pathname !== '/Admin_Dashboard' && location.pathname !== '/Trainer_Dashboard' && <Navbar isloggedin={isloggedin} logoutclicked={logoutclicked} isloggedin_admin={isloggedin_admin} isloggedin_trainer={isloggedin_trainer} />}
       */}

       {
  location.pathname !== '/' &&
  location.pathname !== '/Admin_Dashboard' &&
  location.pathname !== '/workout_dashboard' &&
  location.pathname !== '/trainer_management' &&
  location.pathname !== '/add_food' &&
  location.pathname !== '/Trainer_Dashboard' &&
  location.pathname !== '/trainer_dashboard/edit_workout_plan' &&
  location.pathname !== '/add_remove_workout_trainer' &&
  location.pathname !== '/trainer_dashboard/edit_diet_plans' &&
  location.pathname !== '/trainer_dashboard/add_workout_plan' &&
  location.pathname !== '/trainer_dashboard/add_diet_plan' &&
