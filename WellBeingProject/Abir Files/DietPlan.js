    ...
    meals: [
      {
        ...
        carbs: 45,
        fat: 6,
        image: process.env.PUBLIC_URL + "/images/oatmeal.jpg", // Image for Oatmeal
      },
      {
        time: "Noon",
        ...
        carbs: 20,
        fat: 15,
        image: process.env.PUBLIC_URL + "/images/chicken_salad.jpg", // Image for Chicken Salad
      },
      {
        time: "Afternoon",
        ...
        carbs: 30,
        fat: 5,
        image: process.env.PUBLIC_URL + "/images/smoothie.jpg", // Image for Smoothie
      },
      {
        time: "Night",
        ...
        carbs: 40,
        fat: 18,
        image: process.env.PUBLIC_URL + "/images/salmon_quinoa.jpg", // Image for Salmon with Quinoa
      },
    ],
  };
